...
runEvaluation(
    ...
    templateInstructions({
        ...
        SCHEMA_DESCRIPTION: "Target elements by their spatial center pixel coordinates. This means, refer to them through an x (horizontal) and a y (vertical) pixel coordinate relative to the origin, which is in the top left corner of the image.",
        EXAMPLE_SNAPSHOT: `
\`\`\` base64
